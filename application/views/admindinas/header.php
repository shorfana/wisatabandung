...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Wisata Bandung | Dinas Admin</title>
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1"><?php echo $_SESSION['nama'] ?><i class="mdi mdi-chevron-down"></i> </span>
                            </a>
            ...
            <div class="left side-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>Admin_Dinas/index">
                                <i class="ti-home"></i><span> Dashboard </span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="ti-menu-alt"></i><span>Pemilik Wisata </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="<?php echo base_url()."Admin_Dinas/pemilik_wisata_aktif"; ?>">Sudah Aktivasi</a></li>
                                <li><a href="<?php echo base_url()."Admin_Dinas/pemilik_wisata_nonaktif"; ?>">Belum Aktivasi</a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="<?php echo base_url() ?>Admin_Dinas/data_wisata">
                                <i class="ti-pencil-alt"></i> <span>Data Wisata</span>
                            </a>
                        </li>

                        <li>
                            <a href="javascript: void(0);"><i class="ti-menu-alt"></i><span>Wilayah </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="<?php echo base_url()."Admin_Dinas/data_kelurahan"; ?>">Kelurahan</a></li>
                                <li><a href="<?php echo base_url()."Admin_Dinas/data_kecamatan"; ?>">Kecamatan</a></li>
                            </ul>
                        </li>
