                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    ...
                                    <div class="m-b-20">
                                            <?php echo form_open_multipart("Admin_Dinas/pHapuspemilikwisata"); ?>
                                            <div class="form-group">
                                                <label for="userName">Nama<span class="text-danger">*</span></label>
                                                <input type="text" name="nama" parsley-trigger="change" required readonly
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="NIP" parsley-trigger="change" required readonly
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="noktp" parsley-trigger="change" required readonly
                                                       placeholder="Enter user name" class="form-control" value="<?php echo $noktp ?>" id="noktp">
                                            </div>
                                            <div class="form-group">
                                                <label for="userName">email<span class="text-danger">*</span></label>
                                                <input type="email" name="email" parsley-trigger="change" required readonly
                                                       placeholder="Enter user name" class="form-control" value="<?php echo $email ?>" id="email">
                                            </div>
                                            <div class="form-group">
                                                <label for="pass1">Password<span class="text-danger">*</span></label>
                                                <input id="pass1" type="password" name="password" placeholder="Password" readonly value="<?php echo $password ?>" required
                                                       class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="userName">alamat<span class="text-danger">*</span></label>
                                                <input type="text" name="alamat" parsley-trigger="change"  required readonly
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tempat" parsley-trigger="change" required readonly
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_lahir" parsley-trigger="change" required readonly
                                                       placeholder="Enter user name" value="<?php echo $tgl_lahir ?>" class="form-control" id="noktp">
                                            </div>
                                            <div class="form-group">
                                                <label for="userName">Status Hapus<span class="text-danger">*</span></label>
                                                <select name="dihapus" class="form-control">
                                                    <option>Y</option>
                                                    <option>T</option>
                                                </select>
