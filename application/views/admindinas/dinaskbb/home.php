            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Welcome Admin Dinas Kabupaten Bandung Barat!</h4>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-1.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                                </td>
