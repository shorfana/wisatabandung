            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Data kecamatan</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                        <br><br>
                                        <a href="<?php echo base_url()."Admin_Dinas/tambah_kecamatan" ?>" class="btn btn-custom btn-rounded">Tambah Kecamatan</a>
