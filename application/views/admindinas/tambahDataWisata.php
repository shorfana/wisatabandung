               ...
               <form action="<?php echo base_url() ?>/Pemilik_Wisata/actiontambahwisata" class="form-validation" enctype="multipart/form-data" method="post">
                  <div class="form-group">
                     ...
                     <input type="text" name="kode_wisata" parsley-trigger="change" required
                        placeholder="Masukan Kode Wisata" class="form-control" id="kode_wisata">
                  </div>
                  <div class="form-group">
                     <label>Nama Wisata<span class="text-danger">*</span></label>
                     <input type="text" name="nama_wisata" parsley-trigger="change" required
                        placeholder="Masukan nama Wisata" class="form-control" id="nama_wisata">
                  </div>
                     ...
                     <select class="form-control" name="kecamatan" id="kecamatan">
                        ...
                        <?php
                            foreach ($kecamatan as $kec) {
                                ...
                                <option <?php echo $kecamatan_selected == $kec->kode_kabupaten ? 'selected="selected"' : '' ?>
