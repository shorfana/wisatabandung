                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1">Anderson <i class="mdi mdi-chevron-down"></i> </span>
                            </a>
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>">
                                <i class="ti-pencil-alt"></i> <span> Pengolahan Data Tempat Wisata </span>
                            </a>
                        </li>

                         <li>
                            <a href="<?php echo base_url() ?>Admin_Dinas/pengelola_kecamatan">
                                <i class="ti-pencil-alt"></i> <span> Pengolahan Data Kecamatan </span>
                            </a>
                        </li>

                         <li>
                            <a href="<?php echo base_url() ?>">
                                <i class="ti-pencil-alt"></i> <span> Pengolahan Data Kelurahan </span>
                            </a>
                        </li>
