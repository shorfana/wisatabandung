            ...
            <div class="left side-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url()."Admin_Dinas/tempat_wisata_kot_ban" ?>">
                                <i class="ti-pencil-alt"></i> <span>Tempat Wisata </span>
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo base_url()."Admin_Dinas/pemilik_wisata_kot_ban" ?>">
                                <i class="ti-pencil-alt"></i> <span>Pemilik Wisata </span>
                            </a>
                        </li>

                         <li>
                            <a href="<?php echo base_url() ?>Admin_Dinas/pengelola_kecamatan">
                                <i class="ti-pencil-alt"></i> <span>Kecamatan </span>
                            </a>
                        </li>

                         <li>
                            <a href="<?php echo base_url() ?>">
                                <i class="ti-pencil-alt"></i> <span>Kelurahan </span>
                            </a>
                        </li>
