                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo base_url() ?>dark/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1"><?php// echo $_SESSION['username_sadmin'] ?><i class="mdi mdi-chevron-down"></i> </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="<?php echo base_url()."Pemilik_Wisata/editprofile" ?>" class="dropdown-item notify-item">
            ...
            <div class="left side-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>Pemilik_Wisata/data_wisata">
