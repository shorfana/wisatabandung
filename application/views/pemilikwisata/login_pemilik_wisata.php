                            ...
                            <div class="m-t-40 card-box">
                                <div class="text-center">
                                    <h2 class="text-uppercase m-t-0 m-b-30">
                                        Login Pemilik Wisata
                                    </h2>
                                    <!--<h4 class="text-uppercase font-bold m-b-0">Sign In</h4>-->
                                </div>
                                <div class="account-content">
                                    <form class="form-horizontal" action="<?php echo base_url()."Login/pemilik_wisata_act" ?>" method="POST">
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                <a href="<?php echo base_url()."Login/lupa_password" ?>" class="text-muted pull-right font-14">Forgot your password?</a>
